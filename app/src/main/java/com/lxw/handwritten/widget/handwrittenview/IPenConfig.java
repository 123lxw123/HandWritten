...
public class IPenConfig {
     ...
     * 钢笔
     */
    public static final int STROKE_TYPE_PEN = 1;// 钢笔
    /**
     * 毛笔
     */
    public static final int STROKE_TYPE_BRUSH = 2;// 毛笔

    public static final int PEN_CORLOUR= Color.parseColor("#FF4081");

    //这个控制笔锋的控制值
    public static final float DIS_VEL_CAL_FACTOR = 0.02f;
    //手指在移动的控制笔的变化率  这个值越大，线条的粗细越加明显
    //float WIDTH_THRES_MAX = 0.6f;
    public static final float WIDTH_THRES_MAX = 10f;
