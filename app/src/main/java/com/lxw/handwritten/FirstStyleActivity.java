...
import static com.lxw.handwritten.Constants.FIRST_HEIGHT_SPAN_COUNT;
...
public class FirstStyleActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void setUpView() {
        ...
        editCharacters.setMaxLines(Constants.FIRST_HEIGHT_SPAN_COUNT);
        ...
        editCharacters.post(new Runnable() {
            @Override
            public void run() {
                rowHeight = background.getHeight() / FIRST_HEIGHT_SPAN_COUNT;
                bitmapHeight = rowHeight;
                background.removeAllViews();
                for (int i = 1; i < FIRST_HEIGHT_SPAN_COUNT; i++) {
            ...
            case R.id.color:
                ...
                colorsAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
                    ...
                    public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                        ...
                        UtilSharedPreference.getInstance(FirstStyleActivity.this).setValue(Constants.KEY_DEFAULT_PAINT_COLOR,
